...
const ExploreCard = ({id, imgUrl, title,index,active,handleClick}) => (
  ...
  className={`relative ${active===id?'lg-flex-[3.5] flex-[10]':'lg:flex-[0.5] flex-[2]'} flex items-center justify-center min-w-[170px] h-[700px] transtion-[flex] duration-[0.7s] ease-out-flex cursor-pointer`}
