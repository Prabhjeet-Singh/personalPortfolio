...
const Hero = () => (
  ...
  className={`${styles.innerWidth} mx-auto flex flex-col`}
    >
      <div className="flex justify-center item-center flex-col relative z-10">
        <motion.h1 
      ...
      className="relative w-ull md:-mt-[20px] -mt-[12px]"
      >
        <div
        ...
        />
          ...
          <a href="#explore">
            <div className="w-full flex  justify-end sm:-mt-[70px] -mt-[50px] relative z-10">
              <img src="/stamp.png" alt="stamp" className="sm:w-[155px] w-[100px] sm:h-[155px] h-[100px] object-cotain" />
            </div>
          </a>
